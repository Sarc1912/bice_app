  ...
  return (
    ...
    <div className="m-4">
      ...
      <ul className="mb-4 flex flex-col gap-1">
        ...
        <li>
          <Link href={{ pathname:"/dashboard" }}>
            <button className={`middle none font-sans font-bold center transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg  w-full flex items-center gap-4 px-4 capitalize 'text-white hover:bg-white/10 active:bg-white/30'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-5 h-5 text-inherit">
