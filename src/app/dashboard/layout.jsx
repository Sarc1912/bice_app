...
function layout({ children }) {
  ...
  <Aside user = {user} />
  <div className="p-4 xl:ml-80">    <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
            ...
            <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
              <li className="flex items-center text-blue-gray-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-light-blue-500">
                <a href="#" className='cursor-default'>
                  <p className="block antialiased font-sans text-sm leading-normal text-white-900 font-normal opacity-50 transition-all hover:text-white-500 hover:opacity-100 text-lg" >dashboard</p>
                </a>
              </li>
            </ol>
          </nav>
        ...
        <div className="flex items-center">
          ...
          <a href="#">
            <div className="middle none font-sans font-bold center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 rounded-lg text-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30 hidden items-center gap-1 px-4 xl:flex" type="button">
